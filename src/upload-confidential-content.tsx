...
export const UploadConfidentialContent: React.FC<UploadConfidentialContentProps> =( {instance} ) => {
    ...
    return (
        <div>
            ...
            {encryptionKey !== null && <div>The file was encrypted with this private key: {encryptionKey.toString(16)}</div>}
            ...
            {fileCid === null && encryptionKey === null && "First encrypt the content and provide the CID" }
            {fileCid && encryptionKey !== null && <MintConfidentialToken instance={instance} fileCid={fileCid} contentEncryptionKey={encryptionKey} />}
            </div>
        </div>
    )
