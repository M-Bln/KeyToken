...
export const AskConfidentialData: React.FC<AccessConfidentialDataProps> = ({
  instance,
  token,
  signer,
}) => {
  const [tokenId, setTokenId] = useState<string | null>(null);
  const [signerAddress, setSignerAddress] = useState<`0x${string}` | null>(
    null,
  );
  ...
  return (
    <form onSubmit={submit}>
      ...
      <button type="submit">Get confidential data</button>
